...
Основано на методологиях:
- Jack Daniels (Running Formula): R/I/T/M/E paces
- Норвежская школа: поляризованные тренировки
- Кенийская школа: разнообразие и модуляция
